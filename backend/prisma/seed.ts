...
import { generateSeededCustomers, PRODUCTS } from "../src/lib/simulator/merchant-simulator";
...
async function main() {
  ...
  const customerList = generateSeededCustomers();
  ...
  const order1 = await prisma.order.create({
    data: {
      ...
      productId: PRODUCTS[1].id, // shoes (38% category return risk)
      productName: PRODUCTS[1].name,
      productCategory: PRODUCTS[1].category,
