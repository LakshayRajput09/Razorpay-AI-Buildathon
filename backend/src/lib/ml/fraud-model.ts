...
export interface FraudPredictionResult {
  ...
  recommendedAction: "APPROVE" | "MANUAL_REVIEW" | "BLOCK_TRANSACTION";
}

export function predictFraudRisk(input: FraudPredictionInput): FraudPredictionResult {
  ...
  let recommendedAction: "APPROVE" | "MANUAL_REVIEW" | "BLOCK_TRANSACTION";
