...
import { MasterOrchestrator } from "./lib/agents/orchestrator";
import { ActionEngine } from "./lib/actions/action-engine";
import { predictOrderReturnRisk } from "./lib/ml/growth-model";
...
app.post("/api/predict/fraud", async (req: Request, res: Response) => {
  try {
...
app.post("/api/predict/recovery", async (req: Request, res: Response) => {
  try {
...
app.post("/api/predict/return", async (req: Request, res: Response) => {
  try {
...
app.post("/api/predict/purchase", async (req: Request, res: Response) => {
  try {
...
app.post("/api/predict/chargeback", (req: Request, res: Response) => {
  try {
...
app.get("/api/recovery/opportunities", async (req: Request, res: Response) => {
  try {
...
app.get("/api/finance/cashflow", async (req: Request, res: Response) => {
  try {
...
app.post("/api/finance/scenario", (req: Request, res: Response) => {
  try {
...
app.post("/api/agent/run", async (req: Request, res: Response) => {
  try {
    ...
    const result = await MasterOrchestrator.runTask(query);
    res.json({ success: true, data: result });
  } catch (err: any) {
    res.status(500).json({ success: false, error: err.message });
  }
...
app.post("/api/action/preview", async (req: Request, res: Response) => {
  try {
